...
@with_kw mutable struct hypergraph
    ...
    """
    E::Dict{Int64, Dict} 
    D::Array{Int64, 1} = Array{Integer, 1}()
end
...
function sampleEdges(Z::Vector{Int64}, ϑ::Vector{Float64}, Ω::Any; kmax::Integer=3, kmin::Integer=2)
    """
...
function computeDegrees(E::Dict{Int64, Dict})
    """
