...
# Nvals = [10000, 15000, 20000,25000,100000]
s = 1
...
for ni = 1:length(Nvals)
    ...
    # matwrite("../../fig/performance_throughput/N_$(N)_kmax_($kmax)_davg_($davg)_s_($s)_$tag.mat",
